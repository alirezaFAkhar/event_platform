                            ...
                            <FormItem className="w-full ">
                                <FormControl>
                                    <div className="flex-center h-[54px] w-full overflow-hidden rounded-full bg-grey-50 px-4 py-2 ">
                                        ...
                                        <DatePicker selected={field.value} onChange={(data: Date) => field.onChange(data)} showTimeSelect timeInputLabel="Time" dateFormat='MM/dd/yyyy h:mm aa' wrapperClassName='datePicker' />
                                                ...
                                                <FormItem>
                                                    <FormControl>
                                                        <div className="flex items-center">
                                                            <label htmlFor="isFree" className="whitespace-nowrap pr-3 leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-78">Free Ticket</label>
                                                            <Checkbox id="isFree"
                                                                onCheckedChange={field.onChange}
                                                                checked={field.value}
                                                                className="mr-2 h-5 border-2 w-5 border-primary-500 " />
                                                        </div>
                                                    </FormControl>
                                                    <FormMessage />
                                                </FormItem>
